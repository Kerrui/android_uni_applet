...
public class Annotations {
  ...
  @IntDef({
    ...
    Constants.ERR_ABORTED,
    Constants.ERR_INIT_NET_ENGINE,
    Constants.ERR_RESOURCE_LIMITED,
  ...
  @IntDef({
    ...
    Constants.REMOTE_VIDEO_STATE_REASON_SDK_IN_BACKGROUND,
  })
  @Retention(RetentionPolicy.SOURCE)
