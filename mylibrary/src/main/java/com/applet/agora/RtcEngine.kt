...
class IRtcEngine {
  interface RtcEngineInterface : RtcUserInfoInterface, RtcAudioInterface, RtcVideoInterface,
    ...
    RtcMediaRecorderInterface, RtcExtensionInterface {
    ...
    fun enableExtension(params: Map<String, *>, callback: Callback)
  }
  ...
  interface RtcExtensionInterface {
    fun setExtensionProperty(params: Map<String, *>, callback: Callback)
  }
}
...
open class RtcEngineFactory {
  ...
  open fun create(
    ...
    rtcExtensionEventHandler: RtcExtensionEventHandler
  ): RtcEngine? {
...
//    }
    ...
    val engine = RtcEngineEx.create(mapToRtcEngineConfig(params["config"] as Map<*, *>).apply {
      ...
      mExtensionObserver = rtcExtensionEventHandler
    })
    return engine
  }
}
...
open class RtcEngineManager(
  ...
  private var extensionEventHandler: RtcExtensionEventHandler = RtcExtensionEventHandler { methodName, data ->
    emit(methodName, data)
  }
  ...
  override fun setExtensionProperty(params: Map<String, *>, callback: Callback) {
    callback.code(engine?.setExtensionProperty(
  ...
  override fun create(params: Map<String, *>, callback: Callback) {
    ...
    engine = rtcEngineFactory.create(params, eventHandler, extensionEventHandler)
  ...
  override fun enableExtension(params: Map<String, *>, callback: Callback) {
    callback.code(engine?.enableExtension(
      params["provider"] as String,
      params["extension"] as String,
...
//    callback.code(engine?.switchChannel(token, channelName))
  ...
  override fun takeSnapshot(params: Map<String, *>, callback: Callback) {
    callback.code(engine?.takeSnapshot(
      params["uid"] as Int,
  ...
  override fun setLocalVoiceEqualization(params: Map<String, *>, callback: Callback) {
    callback.code(
      engine?.setLocalVoiceEqualization(
        Constants.AUDIO_EQUALIZATION_BAND_FREQUENCY.fromInt((params["bandFrequency"] as Number).toInt()),
  ...
  override fun setLocalVoiceReverb(params: Map<String, *>, callback: Callback) {
    callback.code(
      engine?.setLocalVoiceReverb(
        Constants.AUDIO_REVERB_TYPE.fromInt((params["reverbKey"] as Number).toInt()),
        (params["value"] as Number).toInt()
      )
    )
  }
