package com.applet.video_player.util;
    ...
    public void exitWithTranslation(float currentY) {
        ...
        anim.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                ((Activity) mContext).overridePendingTransition(R.anim.image_browser_anim_empty, R.anim.image_browser_anim_alpha_out_long_time);
            }
